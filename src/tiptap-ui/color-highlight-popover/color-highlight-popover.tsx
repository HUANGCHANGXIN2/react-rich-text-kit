...
export interface ColorHighlightPopoverContentProps {
  ...
  removeLabel?: string
  highlightColorLabel?: RichTextEditorLabels["highlightColor"]
}
...
export function ColorHighlightPopoverContent({
  ...
  useColorValue = false,
  removeLabel = "清除高亮",
  highlightColorLabel = (label) => `${label}高亮`,
  ...
  const menuItems = useMemo(
    () => [...colors, { label: removeLabel, value: "none" }],
    [colors, removeLabel]
  )
            ...
            {colors.map((color, index) => (
              <ButtonGroup key={color.value}>
                <ColorHighlightButton
                  ...
                  tooltip={color.label}
                  aria-label={highlightColorLabel(color.label)}
...
export function ColorHighlightPopover({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent aria-label={highlightColorsLabel}>
